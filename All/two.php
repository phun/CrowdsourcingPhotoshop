		    ...
		    var addToolTick = function(num) {
      		...
      		var makeTask = function(video, labels) {
      			...
      			var ht = '<div class="section task">' +
						...
						'</div>' + 
						'<div class="info"><div>' +
							'<h3> Which is the best label of the instruction at the 10 second time mark? </h3>' +
				...
				for (labelIndex in labels) {
					...
					var inputString = '<input type="radio" name="labelRadios" value="' + label + '">' + label + '<br>';
...
<div class="section">
<br />
	In this video clip, the cook is going to give a <span class="genreText"></span> instruction at the <strong>10 second time mark</strong>.  We would like to know what it is.
