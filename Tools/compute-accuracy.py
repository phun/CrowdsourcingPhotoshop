...
for i in range(1, 2):
    ...
    print "eps:", eps, "GLOBAL Precision: %.4f Recall:%.4f  F1:%.4f  F2:%.4f  m:%d  fp:%d  fn:%d" % (global_precision, global_recall, global_f1, global_f2, global_match, global_fp, global_fn)
