...
// Set the file to use.
// $data_file = "./data/s1_c.data.chi2014.w1.0.07.final.json";
// $data_file = "./data/s1_m.data.chi2014.w1.0.07.final.json";
$data_file = "./data/s1_p.data.chi2014.w1.0.07.final.json";
